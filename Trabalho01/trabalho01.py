...
Original file is located at
    https://colab.research.google.com/github/EngenhariaSoftwarePUCRS/Inteligencia_Artificial/blob/trabalho/Trabalho01/Trabalho01.ipynb
...
best_k = 16
best_accuracy = 0
for k in range(1, outcomes.get(TEM_JOGO, 0)):
